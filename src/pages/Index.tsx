        ...
        <div className="container">
          ...
          >
            ...
            <p className="mt-6 leading-relaxed text-muted-foreground">
              Each piece begins with carefully selected goat hide, cured and treated using
              methods unchanged for centuries. The leather is then hand-perforated with
              thousands of tiny holes using iron styluses, creating the intricate patterns
              that come alive when backlit. Natural mineral dyes — turmeric yellow, indigo
              blue, pomegranate red — are applied by hand, layer by layer.
            </p>
          </motion.div>
          ...
          <div className="mt-14 grid gap-8 md:grid-cols-3">
            {[
              ...
              >
                <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 font-serif text-lg font-bold text-primary">
                  {i + 1}
                </div>
            ...
            {categories.map((cat, i) => (
              ...
              >
                <Link
                  ...
                  className="group flex h-40 items-end overflow-hidden rounded-lg bg-muted p-6 transition-shadow hover:shadow-lg"
                >
